...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateNavUI(boolean isScanActive) {
        ...
        int textMedium = androidx.core.content.ContextCompat.getColor(this, R.color.text_medium);
        ...
        if (isScanActive) {
            ...
            binding.btnNavDirectory.setTextColor(textMedium);
            binding.btnNavDirectory.setIconTint(android.content.res.ColorStateList.valueOf(textMedium));
        } else {
            // Directory Active
            ...
            binding.btnNavScan.setTextColor(textMedium);
            binding.btnNavScan.setIconTint(android.content.res.ColorStateList.valueOf(textMedium));
        }
    }
